...
export const EvervaultCard = ({
  ...
  function onMouseMove({ currentTarget, clientX, clientY }: any) {
    ...
    const str = generateRandomString(1500*6.6);
    setRandomString(str);
  }
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 flex items-center justify-center">
          <div className="relative h-[37rem] w-[37rem]  rounded-full flex items-center justify-center text-white font-bold text-4xl">
            <div className="absolute w-full h-full bg-white/[0.8] dark:bg-black/[0.8] blur-sm rounded-full" />
            {/* <span className="dark:text-white text-8xl text-black z-20">{text}</span> */}
            {children}
          </div>
        </div>
      </div>
